                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtFullName" class="form-control" placeholder="Nhập tên">
                            </div>

                            <div class="form-group">
                                <label for="">Birthday</label><br>
                                <input type="text" name="txtBirthday" class="form-control" placeholder="Nhập ngày sinh">
                            </div>
